...
export default function CandidateScoreCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setFinal_score(initialValues.final_score);
    setBelievability(initialValues.believability);
    setReliability(initialValues.reliability);
    setEmotional(initialValues.emotional);
    setUndesirability(initialValues.undesirability);
    setErrors({});
  };
  const validations = {
    final_score: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          await DataStore.save(new CandidateScore(modelFields));
          if (onSuccess) {
      ...
      {...rest}
      {...getOverrideProps(overrides, "CandidateScoreCreateForm")}
    >
      <TextField
        label="Final score"
        isRequired={false}
