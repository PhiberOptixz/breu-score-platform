...
export default function CandidateProfileUpdateForm(props) {
  const {
    id,
    candidateProfile,
    onSuccess,
  ...
  const resetStateValues = () => {
    const cleanValues = { ...initialValues, ...candidateProfileRecord };
    setName(cleanValues.name);
    setProfile_pic(cleanValues.profile_pic);
    setReliabilityVideoTest(cleanValues.ReliabilityVideoTest);
    setReliabilityObjTypeTest(cleanValues.ReliabilityObjTypeTest);
    setCandidateReliabilityScore(cleanValues.CandidateReliabilityScore);
    setCandidateScore(cleanValues.CandidateScore);
    setCandidateBelievability(cleanValues.CandidateBelievability);
    setCandidateProfileReliabilityVideoTestId(
      cleanValues.candidateProfileReliabilityVideoTestId
    );
    setCandidateProfileReliabilityObjTypeTestId(
      cleanValues.candidateProfileReliabilityObjTypeTestId
    );
    setCandidateProfileCandidateReliabilityScoreId(
      cleanValues.candidateProfileCandidateReliabilityScoreId
    );
    setCandidateProfileCandidateScoreId(
      cleanValues.candidateProfileCandidateScoreId
    );
    setCandidateProfileCandidateBelievabilityId(
      cleanValues.candidateProfileCandidateBelievabilityId
    );
    setErrors({});
  };
  const [candidateProfileRecord, setCandidateProfileRecord] =
    React.useState(candidateProfile);
  React.useEffect(() => {
    const queryData = async () => {
      const record = id
        ? await DataStore.query(CandidateProfile, id)
        : candidateProfile;
      setCandidateProfileRecord(record);
    };
    queryData();
  }, [id, candidateProfile]);
  React.useEffect(resetStateValues, [candidateProfileRecord]);
  const validations = {
    name: [{ type: "Required" }],
    profile_pic: [],
    ReliabilityVideoTest: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          await DataStore.save(
            CandidateProfile.copyOf(candidateProfileRecord, (updated) => {
      ...
      {...rest}
      {...getOverrideProps(overrides, "CandidateProfileUpdateForm")}
    >
      <TextField
        label="Name"
        isRequired={true}
      ...
      <TextField
        ...
        isRequired={false}
        isReadOnly={false}
        defaultValue={candidateProfileReliabilityVideoTestId}
        onChange={(e) => {
          let { value } = e.target;
          if (onChange) {
            const modelFields = {
      ...
      <TextField
        ...
        isRequired={false}
        isReadOnly={false}
        defaultValue={candidateProfileReliabilityObjTypeTestId}
        onChange={(e) => {
          let { value } = e.target;
          if (onChange) {
            const modelFields = {
      ...
      <TextField
        ...
        isRequired={false}
        isReadOnly={false}
        defaultValue={candidateProfileCandidateReliabilityScoreId}
        onChange={(e) => {
          let { value } = e.target;
          if (onChange) {
            const modelFields = {
      ...
      <TextField
        ...
        isRequired={false}
        isReadOnly={false}
        defaultValue={candidateProfileCandidateScoreId}
        onChange={(e) => {
          let { value } = e.target;
          if (onChange) {
            const modelFields = {
      ...
      <TextField
        ...
        isRequired={false}
        isReadOnly={false}
        defaultValue={candidateProfileCandidateBelievabilityId}
        onChange={(e) => {
          let { value } = e.target;
          if (onChange) {
            const modelFields = {
